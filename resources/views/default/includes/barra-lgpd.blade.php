<section class="barra-lgpd d-print-none" id="bar-lgpd">
    <div class="icon">
    ...
    <div class="text">
        {{$config['titulo_site']}} utiliza cookies e outras tecnologias semelhantes para melhorar a sua experiência de acordo com a nossa <a href="{{route('politica-de-privacidade')}}">Política de Privacidade</a> e <a href="{{route('termos-de-uso')}}">Termos de Uso</a>, ao continuar navegando você concorda com estas condições.
    </div>
    <div class="button">
