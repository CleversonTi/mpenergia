        ...
        <div class="row align-items-center justify-content-around">
            ...
            <div class="col-lg-4 offset-lg-1">
                <div class="index-contato__left">
                    ...
                    <div class="footer-descricao">
                       ...
                       @endif
                       @php
                           $zapLink = $config['whatsapp']['link'] ?? ($config['unidades'][0]['whatsapp']['link'] ?? '#');
                       @endphp
            ...
            <div class="col-lg-4 offset-lg-1 form">
                <div class="index-contato__form-card">
                    ...
                    <form name="{{ $form_name ?? 'index_contato' }}"
                          novalidate
                        ...
                        <div class="row g-3">
                            ...
                            <input type="hidden" ng-model="form.assunto" ng-init="form.assunto='Contato - Página Inicial'">
