...
@section('content')
    ...
    @include('default.index.index-destaque-produtos', [
        ...
        'link_categoria' => route('produtos-categorias', [
            'uri' => $produtos_destaques[SiteController::CATEGORIA_HOSPITALAR]['uri'],
        ]),
    ...
    @include('default.index.index-destaque-produtos', [
        ...
        'link_categoria' => route('produtos-categorias', [
            'uri' => $produtos_destaques[SiteController::CATEGORIA_ESTETICA]['uri'],
        ]),
